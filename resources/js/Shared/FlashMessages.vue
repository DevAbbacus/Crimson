<template>
  <div>
    <div
      ...
      class="mb-6 flex items-center justify-between bg-green-500 rounded"
    >
    ...
    <div
      v-if="$page.flash.warning && show"
      class="mb-6 flex items-center justify-between bg-yellow-400 rounded"
    >
      <div class="flex items-center">
        <svg
          class="ml-4 mr-2 flex-shrink-0 w-4 h-4 fill-white"
      ...
      <button type="button" class="group mr-2 p-2" @click="show = false">
        <svg
          class="block w-2 h-2 fill-yellow-800 group-hover:fill-white"
          xmlns="http://www.w3.org/2000/svg"
          width="235.908"
          height="235.908"
          viewBox="278.046 126.846 235.908 235.908"
