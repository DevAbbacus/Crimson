<template>
  <form class="resource-form">
    ...
    <jet-input v-if="site_url == 'https://o3.mobilegiz.com'" v-model="form.name_fr" placeholder="Name In French" />
    <jet-input v-if="site_url == 'https://o3.mobilegiz.com'" v-model="form.name_en" placeholder="Name In English" />
    <textarea
      rows="10"
